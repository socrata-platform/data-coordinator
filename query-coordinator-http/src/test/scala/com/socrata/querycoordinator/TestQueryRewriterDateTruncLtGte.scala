...
class TestQueryRewriterDateTruncLtGte extends TestQueryRewriterDateTruncBase {
  val rewrittenQueryRymd = "SELECT c2 as ward, sum(c3) as count " +
    "WHERE c1 >= '2011-03-08' AND c1 < '2019-08-02' GROUP BY c2"
  ...
  val rewrittenQueryRym = "SELECT c2 as ward, sum(c3) as count " +
    "WHERE c1 >= '2011-03-01' AND c1 < '2019-08-01' GROUP BY c2"
  ...
  val rewrittenQueryRy = "SELECT c2 as ward, sum(c3) as count " +
    "WHERE c1 >= '2011-01-01' AND c1 < '2019-01-01' GROUP BY c2"
  ...
  test("9999 filter") {
    ...
    rewrites.get("r_ymd").get should equal(analyzeRewrittenQuery("r_ymd",
      "SELECT c2 as ward, sum(c3) as count " +
        "WHERE c1 >= '2011-03-08' AND c1 < '2019-08-02' AND c1 < '9999-01-01' GROUP BY c2"))
    rewrites should have size 1
  }
  ...
  test("IS NOT NULL filter") {
    ...
    rewrites.get("r_ymd").get should equal(analyzeRewrittenQuery("r_ymd",
      "SELECT c2 as ward, sum(c3) as count " +
        "WHERE c1 >= '2011-03-08' AND c1 < '2019-08-02' AND c1 IS NOT NULL GROUP BY c2"))
    rewrites should have size 1
  }
  ...
  test("shouldn't rewrite") {
    ...
    rewritesFor("SELECT ward WHERE crime_date >= '2012-01-01T01:00:00' " +
      "AND crime_date < '2013-01-01'") should have size 0
  }
