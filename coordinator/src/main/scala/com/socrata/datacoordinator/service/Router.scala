...
case class Router(parseDatasetId: String => Option[DatasetId],
                  ...
                  datasetRollupToResource: DatasetId => SodaResource,
                  datasetRollupFromResource: DatasetId => SodaResource,
                  ...
                  datasetSecondaryBreakageResource: (Option[String], Option[DatasetId]) => SodaResource,
  ...
  val routes = locally {
    ...
    Routes(
      ...
      Route("/dataset-rollup/{DatasetId}/to", datasetRollupToResource),
      Route("/dataset-rollup/{DatasetId}/from", datasetRollupFromResource),
      ...
      Route("/secondary-manifest/broken", datasetSecondaryBreakageResource(None, None)),
      Route("/secondary-manifest/broken/{OptString}", datasetSecondaryBreakageResource(_: Option[String], None)),
      Route("/secondary-manifest/broken/{String}/{DatasetId}",
        { (storeId: String, datasetId: DatasetId) => datasetSecondaryBreakageResource(Some(storeId), Some(datasetId)) }),
